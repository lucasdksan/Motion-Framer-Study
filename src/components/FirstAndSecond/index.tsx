...
const First: React.FC = () => {
  ...
  const firstScale = useTransform(scrollYProgress, [ 0.198, 0.264, 0.588, 0.617 ], [ 1, 0.511, 0.511, 1 ]);
  const firstBorder = useTransform(scrollYProgress, [ 0.198, 0.264, 0.588, 0.617 ], [ 0, 4, 4, 0 ]);
